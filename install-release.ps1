...
<#
.SYNOPSIS
    SafeC Prebuilt Install Script — Windows
...
.DESCRIPTION
    ...
    machine you're installing to. This is the fast path; see install.ps1 for
...
.EXAMPLE
    .\install-release.ps1 -Prefix C:\safec -Version v0.2.0
#>
param(
...
if ($arch -ne "AMD64") {
    Die "No prebuilt release for Windows/$arch yet (only x86_64 is published). Use install.ps1 to build from source instead."
}
