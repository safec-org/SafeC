...
void pb_write_varint(struct String* out, unsigned long long v) {
    while (v >= 0x80ULL) {
...
void pb_write_tag(struct String* out, int field_num, int wire_type) {
...
void pb_write_int64_field(struct String* out, int field_num, long long v) {
    pb_write_tag(out, field_num, PB_WIRE_VARINT);
    pb_write_varint(out, (unsigned long long)v); // sign-extends, matching protoc
}

void pb_write_uint64_field(struct String* out, int field_num, unsigned long long v) {
    pb_write_tag(out, field_num, PB_WIRE_VARINT);
    pb_write_varint(out, v);
}

void pb_write_sint64_field(struct String* out, int field_num, long long v) {
    pb_write_tag(out, field_num, PB_WIRE_VARINT);
    unsigned long long zigzag = ((unsigned long long)(v << 1)) ^ (unsigned long long)(v >> 63);
    pb_write_varint(out, zigzag);
}

void pb_write_bool_field(struct String* out, int field_num, int v) {
    pb_write_tag(out, field_num, PB_WIRE_VARINT);
    pb_write_varint(out, v != 0 ? 1ULL : 0ULL);
}

void pb_write_double_field(struct String* out, int field_num, double v) {
...
void pb_write_float_field(struct String* out, int field_num, float v) {
...
void pb_write_string_field(struct String* out, int field_num, const char* s) {
...
void pb_write_bytes_field(struct String* out, int field_num,
...
int pb_reader_has_more(const struct PbReader* r) {
    unsigned long pos;
    unsigned long len;
...
int pb_read_varint(struct PbReader* r, unsigned long long* out) {
...
int pb_read_tag(struct PbReader* r, int* field_num, int* wire_type) {
...
int pb_read_int64(struct PbReader* r, long long* out) {
...
int pb_read_uint64(struct PbReader* r, unsigned long long* out) {
    return pb_read_varint(r, out);
}

int pb_read_sint64(struct PbReader* r, long long* out) {
    unsigned long long v;
    if (!pb_read_varint(r, &v)) { return 0; }
...
int pb_read_bool(struct PbReader* r, int* out) {
    unsigned long long v;
    if (!pb_read_varint(r, &v)) { return 0; }
...
int pb_read_double(struct PbReader* r, double* out) {
    unsigned long pos;
    unsigned long len;
    unsafe { pos = r->pos; len = r->len; }
...
int pb_read_float(struct PbReader* r, float* out) {
    unsigned long pos;
    unsigned long len;
    unsafe { pos = r->pos; len = r->len; }
...
int pb_read_length_delimited(struct PbReader* r, const unsigned char** dataOut,
...
int pb_skip_field(struct PbReader* r, int wire_type) {
